...
| 第一遍：选择留下足迹 | 第二遍：三段解锁信笺 | 结局：玫瑰盛放 |
| --- | --- | --- |
| ![带选择足迹和动作提示的外卖粥选择](poster/trifold/first-pass-v1.png) | ![三段回看完成后的记忆地图](poster/trifold/memory-map-v1.png) | ![盛放结局](docs/ppt-screenshots/5.png) |
